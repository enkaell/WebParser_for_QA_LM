...
os.chdir(path)
files = [filename for filename in os.listdir(path) if ".json" in filename and "cleaned" in filename and "space" not in filename and "earth" not in filename
         and "biology" not in filename]
